...
parser.add_argument('--checkpoint-path', default='./data/europarl/checkpoints4/deepsc-AWGN', type=str)
...
parser.add_argument('--bert-config-path', default='./data/europarl/bert/uncased_L-12_H-768_A-12/bert_config.json', type = str)
parser.add_argument('--bert-checkpoint-path', default='./data/europarl/bert/uncased_L-12_H-768_A-12/bert_model.ckpt', type = str)
parser.add_argument('--bert-dict-path', default='./data/europarl/bert/uncased_L-12_H-768_A-12/vocab.txt', type = str)
