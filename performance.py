...
parser.add_argument('--checkpoint-path', default='./data/europarl/checkpoints1/deepsc-Rayleigh', type=str)
...
parser.add_argument('--bert-config-path', default='./data/europarl/bert/bert_config.json', type = str)
parser.add_argument('--bert-checkpoint-path', default='./data/europarl/bert/bert_model.ckpt', type = str)
parser.add_argument('--bert-dict-path', default='./data/europarl/bert/vocab.txt', type = str)
